...
class NewQuiz extends Component {
  ...
  handleCreateQuiz(){
    this.props.socket.emit('addQuiz', {quizTitle: this.state.quizTitle,
                            username:this.props.app.state.username}, (resp)=> {this.props.app.setState({mode: "questions", currQuizID: resp.currQuizID})})
